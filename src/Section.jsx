      ...
      <div className="block container p-10 m-auto">
            ...
            <h3 className="text-4xl font-semibold text-white">It's lunchtime somewhere anyway! Order Now!!</h3>
             <div className="space-x-4 container">
                <button className="mt-5 text-lg p-1 text-gray-400 md:p-2 mb-2 md:text-2xl bg-white rounded-md  hover:text-white hover:bg-orange-500"><i class="fa-solid fa-motorcycle"></i> Delivery</button>
                <button className="mt-5 text-lg p-1 text-gray-400 md:p-2 mb-2 md:text-2xl bg-white rounded-md hover:text-white hover:bg-orange-500"><i class="fa-solid fa-bag-shopping"></i> pickup</button>
             </div>
